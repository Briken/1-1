...
public class TricksterEditor : Editor {
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (trickster.m_expiringOption == ExpireOptions.Destroy || trickster.m_expiringOption == ExpireOptions.Stay)
        {
        ...
        {
            EditorGUILayout.HelpBox("Objects will loop back to the first instead of expiring.", MessageType.Info);
        }
